...
### 資料更新
- **2026-01 月營收資料收集**（2026-02-10）
  - 執行 Revenue Pipeline 增量收集
  - **本次新增**: 619 檔（今日新公告）
  - **累計公告**: 1,757/1,940 檔（90.6%）
  - **資料檔案**: `data/raw/revenue-daily/2026/2026-01.json`（872 KB）
  - **收集模式**: Daily 模式（智慧判斷，10 號前自動使用）
  - **執行時間**: 約 5 分鐘（查詢 802 檔未公告股票）
  - **重點發現**:
    - 整體市場表現強勁：70.3% 公司年增率正成長
    - AI 伺服器產業鏈持續成長（緯創 +151%、廣達 +61%、文曄 +151%）
    - 半導體記憶體復甦明顯（南亞科 +608%、創見 +441%）
    - 營建產業低基期效應（遠雄 +2495%、興富發 +2481%）
