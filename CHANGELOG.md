...
### 新增
- **錢線百分百節目分析報告**（2026-02-27）
  - 新增 2026-02-26/27 完整三集分析報告
  - **檔案位置**: `data/transcripts/yt-moneyline/2026-02-27/`
  - **內容**:
    - `moneyline_20260227_part1_analysis.md` - 上集分析（655 行）
    - `moneyline_20260227_part2_analysis.md` - 中集分析（533 行）
    - `moneyline_20260227_part3_analysis.md` - 下集分析（505 行）
    - `daily_summary.md` - 每日總覽（397 行）
    - 原始逐字稿 TXT 檔案（上/中/下三集）
  - **主要議題**:
    - 台股：股王信驊破千萬、三月財報交易法、AI組裝股機會
    - 美股：NVIDIA財報解析、記憶體產業革命、MWC/衛星展概念股
    - 投資策略：華爾街13F報告、美股ETF全攻略、黃金萬口選擇權
  - **來賓**: 盡老師、明哲、支援（政遠）、書方、黃志源、蘇律師
