...
#### 台灣證交所與櫃買中心官方 API (主要來源)
- **優點**:
  - **完全免費**且無請求頻率限制
  - **即時資料**，無延遲
  - **官方來源**，資料最準確
  - **Aggregate API**，一次取得所有股票
  - 涵蓋價量、法人、融資融券等資料
- **API 端點**:
  - TWSE（上市）: `https://openapi.twse.com.tw/v1/`
  - TPEx（上櫃）: `https://www.tpex.org.tw/openapi/v1/`
- **效能優勢**:
  - 只需 2 次 API 請求即可取得 1,946 檔股票資料
  - 相比逐檔查詢提升 **973 倍**效率

#### 其他資料來源 (備用/補充)
- **FinMind API** (已棄用): 免費版有 30 天延遲限制
- **證券櫃買中心 (TPEx)**: 上櫃股票資料
