...
| 檔案存在性 | ✅ PASS | - |
| JSON 格式 | ✅ PASS | - |
| 資料筆數 | ✅ PASS | 1,946 筆 (範圍: 1,500~2,500) |
| 必要欄位 | ✅ PASS | 所有欄位完整 |
| 數值範圍 | ⚠️ WARN | 2 筆資料超出預期範圍 |
| 邏輯一致性 | ✅ PASS | - |
...
#### 2.2 必要欄位檢查
- ✅ date: 1,946/1,946 (100%)
- ✅ stock_id: 1,946/1,946 (100%)
- ✅ stock_name: 1,946/1,946 (100%)
- ✅ open: 1,946/1,946 (100%)
- ✅ high: 1,946/1,946 (100%)
- ✅ low: 1,946/1,946 (100%)
- ✅ close: 1,946/1,946 (100%)
- ✅ volume: 1,946/1,946 (100%)

### 3. 合理性驗證

#### 3.1 數值範圍檢查
- ✅ 價格範圍: 0.01 ~ 10,000 (1,944/1,946 = 99.9%)
- ⚠️ 超出範圍:
  - 2330: close = 10,500 (超過上限 10,000)
  - 2454: close = 12,000 (超過上限 10,000)

#### 3.2 邏輯一致性檢查
- ✅ high >= low: 1,946/1,946 (100%)
- ✅ high >= open: 1,946/1,946 (100%)
- ✅ high >= close: 1,946/1,946 (100%)
- ✅ low <= open: 1,946/1,946 (100%)
- ✅ low <= close: 1,946/1,946 (100%)
- ✅ volume >= 0: 1,946/1,946 (100%)
...
本次驗證發現 2 筆數值超出預期範圍，但屬於高價股正常現象，不影響資料正確性。資料完整性與邏輯一致性均通過驗證，可安全使用。
...
#### 2. 報告儲存位置
- 與資料檔案同目錄: `data/raw/{type}/{YYYY}/{MM}/`
- 檔案命名: `{YYYY-MM-DD}-report.md`
- 保留所有歷史報告
